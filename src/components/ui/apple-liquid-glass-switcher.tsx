...
const themeOptions: { value: Theme; dataOption: string; icon: React.ReactNode }[] = [
    {
        value: "light",
        dataOption: "1",
        icon: (
...
export function ThemeSwitcher({
    ...
    // This variable was not used, but updated for consistency if it were to be used.
    ...
    return (
        <fieldset
            className={["switcher", className].filter(Boolean).join(" ")}
            data-previous={
                themeOptions.find((o) => o.value === activeValue)?.dataOption
            }
        >
